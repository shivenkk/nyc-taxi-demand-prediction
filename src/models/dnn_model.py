...
def save_results(best_model, results_df, scaler, best_history, feature_names, output_dir):
    """
...
if __name__ == "__main__":
    ...
    save_results(best_model, results_df, scaler, best_history, X_train.columns, output_dir)
